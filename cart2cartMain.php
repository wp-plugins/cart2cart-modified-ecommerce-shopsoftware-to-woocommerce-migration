 ...
 */
/*
Plugin Name: Cart2Cart: modified eCommerce ShopSoftware to WooCommerce Migration Module
...
function cart2cart_config(){
	...
	$sourceCartName = 'modified eCommerce ShopSoftware';
  $sourceCartId = 'Modified';
